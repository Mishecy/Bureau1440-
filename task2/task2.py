...
def min_sub_len(sequence):
    ...
    for right, num in enumerate(sequence):
        if num in required:
            count[num] += 1
            if count[num] == 1:
                unique_in_window += 1

        while unique_in_window == 26:
